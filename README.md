...
2. Survival Analysis (The "8-Month Peak")
  We utilized Kaplan-Meier Survival Estimators to model the time until a member churns, and identified a critical "Hazard Zone" at the 8-month mark. This suggests a "Trial Phase" where members lose interest if they haven't achieved a "meaningful win" (e.g., their first redemption) within two fiscal quarters.
